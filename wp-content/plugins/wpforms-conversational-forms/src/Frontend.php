...
class Frontend {
	...
	public function conversational_form_hooks() {
		...
		add_filter( 'wpforms_process_before_form_data', [ $this, 'prepare_date_dropdowns' ] );
	...
	public function meta_robots() {
		...
		_deprecated_function( __CLASS__ . '::' . __METHOD__, '1.6.0 of the Conversational Forms WPForms addon', __CLASS__ . '::meta_tags()' );
	...
	public function yoast_seo_description() {
		...
		_deprecated_function( __CLASS__ . '::' . __METHOD__, '1.6.0 of the Conversational Forms WPForms addon', __CLASS__ . '::get_description()' );
